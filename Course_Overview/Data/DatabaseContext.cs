...
namespace Course_Overview.Data
{
	public class DatabaseContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
            ...
            //Cấu hình mối quan hệ 2 bảng Course và COurseRegitration
            modelBuilder.Entity<CourseRegistration>()
                .HasOne(cr => cr.Course)
                .WithMany(c => c.CourseRegistrations)
                .HasForeignKey(cr => cr.CourseID);

			//Cấu hình mối quan hệ 2 bảng Student và COurseRegitration
			modelBuilder.Entity<CourseRegistration>()
		...
		public DbSet<CourseRegistration> CourseRegistrations { get; set; }     // Bảng đăng ký khóa học 
